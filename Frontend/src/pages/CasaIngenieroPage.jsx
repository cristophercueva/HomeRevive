                    ...
                    <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-4xl mx-auto">
                        <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
                            <div className="flex flex-wrap -mx-2">
                                ...
                                <div className="w-full sm:w-1/3 px-2 mb-4">
                                    <label htmlFor="trabajador2Id" className="block text-gray-700 text-sm font-bold mb-2">Trabajador</label>
                                    <select
                                        {...register("trabajador2Id", {
                                    ...
                                    >
                                        ...
                                        {trabajadores
                                            .filter(trabajador => trabajador.cargo === 'Arquitecto')
                                            .map((trabajador) => (
                                                <option key={trabajador._id} value={trabajador._id}>{trabajador.name}</option>
                                            ))
                                        }
                                    </select>
                                    {errors.trabajador2Id && <p className="text-red-500">{errors.trabajador2Id.message}</p>}
                                </div>
                            </div>
                            ...
                            <label htmlFor="campocasa" className="block text-gray-700 text-sm font-bold mb-2">Campos casa</label>
                                ...
                                <button onClick={agregarCampo} type="button" className="px-4 py-2 bg-blue-500 text-white rounded">
                                    Agregar
                                </button>
...
export default CasaIngenieroPage